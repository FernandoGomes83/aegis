# Aegis Input Doc Types — Recommended Reference

> **Purpose**: This document defines the recognized input document types for the Aegis framework, how auto-classification works, and the merge rules for the `security` type.
>
> Input docs are the raw materials fed to the `/aegis` skill before artifact generation. The skill reads, classifies, and synthesizes them into requirements, design, tasks, and tests.

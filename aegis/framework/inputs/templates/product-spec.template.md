...
> **Instructions**: Fill in each section below. Be concrete — avoid vague language like "easy to use" or "scalable". The Aegis skill will extract requirements directly from this document, so specificity here directly improves the quality of generated artifacts.
>

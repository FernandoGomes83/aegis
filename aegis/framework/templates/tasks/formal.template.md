...
---
**TASK-003: Checkpoint — {{checkpoint_1.description}}**
...
Implements: {{task_004.implements}}
...
Depends on: {{task_sec_001.depends_on}}
  ...
  TASK-NNN.2: {{task_sec_001.sub2.description}} ({{task_sec_001.sub2.hours}})
    Validates: TEST-SEC-{{task_sec_001.sec_prop_key}}
...
---
**TASK-NNN: Checkpoint — {{checkpoint_2.description}}**
...
| TASK | Depends on | Parallel with | Est. (h) | Critical path |
|------|------------|---------------|----------|---------------|
| {{task.id}} | {{task.depends}} | {{task.parallel}} | {{task.estimate}} | {{task.critical}} |

### Execution Phases

Phase 1 (parallel): {{phase_1.tasks}} — phase duration: {{phase_1.duration}}

...
console.log("");
console.log("  Optional — build progress in status line:");
console.log("    Add to .claude/settings.json under hooks.StatusLine:");
console.log('    {"type": "command", "command": "bash .claude/aegis/scripts/aegis-build-statusline.sh"}');
console.log("");

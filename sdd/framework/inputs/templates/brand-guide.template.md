...
> **Instructions**: Fill in each section below. The SDD skill uses this document to ensure generated design artifacts reflect brand constraints — particularly in UI components, copy tone, and visual decisions. The more concrete the values here, the less ambiguity in downstream design decisions.
>
